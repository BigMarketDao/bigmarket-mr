...
**Read this if you only read one doc in `docs/design/`.** This is plain-English, screenshot-friendly, written for a product-minded reader. It is the answer to: *"what does 'professional but approachable' actually mean for our UI, and where are we today?"*
