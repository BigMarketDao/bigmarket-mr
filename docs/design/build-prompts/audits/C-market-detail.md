...
> Read-only audit of [`docs/design/build-prompts/C-market-detail.md`](./C-market-detail.md), checking it against:
...
**Evidence.** [`docs/design/build-prompts/C-market-detail.md:78-117`](./C-market-detail.md) shows BEFORE as:
