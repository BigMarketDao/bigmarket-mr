...
DO NOT modify the prompt files (docs/design/build-prompts/A-token-wiring.md, B-homepage.md, C-market-detail.md, B0-header-chrome.md) or any other file.
...
1. `docs/design/tokens-and-rules.lock.md` — the locked decisions everything else cites.
2. `docs/design/current-vs-target.md` — plain-English target state.
3. `docs/design/design-philosophy.md` — why we use Skeleton `nouveau` and what "professional but approachable" means concretely.
4. `docs/design/styling-contract.md` — the rules of usage and tier model.
5. `docs/design/bm-semantic-tokens-proposal.md` — semantic token inventory.
6. `docs/design/skeleton-theme-nouveau.md` — palette baseline + charts decision.
7. `docs/design/audit-report.md` — the gap audit this whole effort responds to.

Prompts to audit (the work product):

8. `docs/design/build-prompts/A-token-wiring.md`
9. `docs/design/build-prompts/B0-header-chrome.md`
10. `docs/design/build-prompts/B-homepage.md`
11. `docs/design/build-prompts/C-market-detail.md`
...
- If the docs disagree with each other anywhere, name the disagreement and which one wins per the source-of-truth rules in `docs/design/sources-of-truth.md`.
...
- Prompt line: `docs/design/build-prompts/{X}.md` — section heading + the wording.
- What goes wrong if I run the prompt as-is: 1–2 sentences.

**Proposed replacement text:**

Replace this block in `docs/design/build-prompts/{X}.md`:
