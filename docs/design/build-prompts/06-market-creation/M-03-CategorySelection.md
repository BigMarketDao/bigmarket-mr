# Market Creation · M-03 — CategorySelection

**File:** `packages/bm-create-market/src/lib/CategorySelection.svelte`
**Model:** Haiku 4.5
**Time:** ~5 min
...
`packages/bm-create-market/src/lib/CategorySelection.svelte`
...
- **Focus rings:** add `focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none` to category option buttons.
...
- Zero Tier-1 palette utilities. Category buttons have focus rings. Light + dark parity.
