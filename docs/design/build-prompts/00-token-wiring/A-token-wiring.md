...
1. `docs/design/tokens-and-rules.lock.md` — the source of all values you will land.
...
```css
	...
	--color-price-neutral: var(--color-muted-foreground);
 ...
 * Update both together. See `docs/design/tokens-and-rules.lock.md`.
 */
export const tokens = {
  light: {
    colors: {
