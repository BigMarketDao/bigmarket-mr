...
> **Lock alignment:** Same as C-14 — Prompt A does **not** add `chart-*` tokens yet. Use structural semantics (`border`, `muted-foreground`) for grid/axis until `docs/design/PROMPTS.md` Step 8.
