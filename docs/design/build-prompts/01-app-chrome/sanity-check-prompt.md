...
1.  docs/design/tokens-and-rules.lock.md
2.  docs/design/build-prompts/A-token-wiring.md
3.  docs/design/build-prompts/B0-header-chrome.md
4.  docs/design/build-prompts/B-homepage.md
5.  docs/design/build-prompts/C-market-detail.md
6.  docs/design/build-prompts/audits/B0-header.md          (prior audit of B0)
7.  docs/design/build-prompts/audits/C-market-detail.md   (prior audit of C)
