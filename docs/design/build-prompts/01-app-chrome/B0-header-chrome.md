...
1. `docs/design/tokens-and-rules.lock.md` (§1.1 surfaces, §1.2 status quad, §1.3 community).
2. `docs/design/current-vs-target.md` (§2 "Where we are today" — the chrome sections).
3. `docs/design/design-philosophy.md` §4 (professional but approachable), §6 (do/don't).
