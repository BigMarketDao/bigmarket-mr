...
<PageContainer>
	...
	<div class="mb-8 md:flex md:items-center md:justify-between">
		<div class="min-w-0 flex-1">
			<h1 class="text-xl leading-7 font-semibold text-foreground sm:text-2xl">My Markets</h1>
				...
				<div class="rounded border border-border bg-card shadow-sm">
					...
					<div>
						...
						{:else if filteredMarkets && filteredMarkets.length > 0}
							...
							{/key}
						{:else}
							<div class="rounded border border-border bg-muted p-8 text-center shadow-sm">
								<div class="mx-auto">
									<h3 class="text-base font-medium text-foreground">No markets found</h3>
	...
	{:else}
		<div class="mx-auto max-w-2xl">
			<div class="rounded border border-border bg-card p-6 text-center shadow-sm">
				<h3 class="mb-2 text-base font-semibold text-foreground">Connect Your Wallet</h3>
