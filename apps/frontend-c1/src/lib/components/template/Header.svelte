	...
	{#if isOpen}
		...
		>
			<div class="mx-auto max-w-7xl p-4">
				...
				<div class="mb-4 space-y-1 border-b border-border pb-4">
					{#if typeof window !== 'undefined'}
						...
						>
							...
							<div class="flex-1">
								<div class="text-sm font-semibold text-foreground">BigMarket IDO</div>
						...
						{#if isLoggedIn()}
							...
							>
								...
								<div class="flex-1">
									<div class="text-sm font-semibold text-foreground">My Bets</div>
					...
					>
						...
						<div class="flex-1">
							<div class="text-sm font-semibold text-foreground">Reputation Hub</div>
				...
				<div class="mb-4 flex items-center justify-between border-b border-border py-2">
					...
					<div class="space-y-3">
						...
						<div class="space-y-1">
							...
							>
								...
								<div class="flex-1">
									<div class="text-sm font-medium text-muted-foreground">Top Traders</div>
							...
							>
								...
								<div class="flex-1">
									...
									<div class="text-xs text-muted-foreground">Customize your experience</div>
								</div>
							</a>
