...
// async function fetchBalanceAtTier(stacksApi: string, contractAddress: string, contractName: string, address: string, tier: number): Promise<number> {
// 	const data = {
...
// }
// async function fetchBalances(stacksApi: string, contractAddress: string, contractName: string, address: string): Promise<number[]> {
...
// async function fetchOverallBalance(stacksApi: string, contractAddress: string, contractName: string, address: string): Promise<any> {
// 	const data = {
// 		contractAddress: contractAddress,
// 		contractName: contractName,
...
// async function fetchWeightedReputation(stacksApi: string, contractAddress: string, contractName: string, address: string): Promise<any> {
// 	const data = {
// 		contractAddress: contractAddress,
// 		contractName: contractName,
...
// async function fetchCurrentEpoch(stacksApi: string, contractAddress: string, contractName: string): Promise<any> {
// 	const data = {
// 		contractAddress,
// 		contractName,
...
// async function fetchTotalSupplies(stacksApi: string, contractAddress: string, contractName: string): Promise<number[]> {
// 	const supplies: number[] = [];
...
// async function fetchWeightedSupply(stacksApi: string, contractAddress: string, contractName: string): Promise<any> {
// 	const data = {
// 		contractAddress: contractAddress,
// 		contractName: contractName,
