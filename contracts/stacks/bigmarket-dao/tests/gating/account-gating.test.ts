...
describe('gating market  creation', () => {
	...
	it('GENERATE TESTNET MERKLE ROOTS FOR MARKET CREATION', async () => {
		...
		const lookupRootKey = contractId2Key('ST30Q4WJYHGMYEE1CTGQ334R9M7KQ8ETVQ9NB134T.bme023-0-market-scalar-pyth');
		console.log(
			'ST30Q4WJYHGMYEE1CTGQ334R9M7KQ8ETVQ9NB134T, ST2T1JM78TXGP1PNMEGMPARAA91MKYJPNETFERNAN, ST167Z6WFHMV0FZKFCRNWZ33WTB0DFBCW9M1FW3AY, ST105HCS1RTR7D61EZET8CWNEF24ENEN3V6ARBYBJ, ST3SJD6KV86N90W0MREGRTM1GWXN8Z91PF6W0BQKM, STEZD95XQ194X67C1QJW4PHKDG8F5D66ZCYFX27A '
		);
		console.log('--------------------------------------------------------------------------------------------------------------');
		...
		console.log('--------------------------------------------------------------------------------------------------------------');
		allowedCreators = [
			'SPT94T4HGFN8A99AH4DEE3E5EM7J6JN8FKY8KB7Z',
		...
		const lookupRootKey1 = contractId2Key('SPT94T4HGFN8A99AH4DEE3E5EM7J6JN8FKY8KB7Z.bme024-0-market-scalar-pyth');
		console.log('--------------------------------------------------------------------------------------------------------------');
		console.log(allowedCreators);
		console.log(
			'MAINNET: MERKLE ROOTS FOR MARKET CREATION: \nSPT94T4HGFN8A99AH4DEE3E5EM7J6JN8FKY8KB7Z.bme023-0-market-scalar-pyth: \nkey= 0x' +
				lookupRootKey1 +
				'\nroot= 0x' +
				newRoot.root
			//tree
		...
		//let merklProof1 = generateMerkleProof(newRoot.tree, 'ST3RR3HF25CQ9A5DEWS4R1WKJSBCFKQXFBYPJK3WV');
		const lookupRootKey2 = contractId2Key('ST30Q4WJYHGMYEE1CTGQ334R9M7KQ8ETVQ9NB134T.bme023-0-market-scalar-pyth');
		console.log('--------------------------------------------------------------------------------------------------------------');
		console.log(allowedCreators);
		console.log(
