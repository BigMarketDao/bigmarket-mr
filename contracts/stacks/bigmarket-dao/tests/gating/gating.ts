...
export function generateMerkleTreeUsingStandardPrincipal(addresses: Array<string>) {
...
export function proofToClarityValue(proof: Array<{ data: Uint8Array; position: string }>): ListCV<ClarityValue> {
...
function encodeToConsensusBuffer(name: string) {
	...
	const consensusBuffer = new Uint8Array([...typePrefix, ...lengthPrefix, ...asciiBytes]);
