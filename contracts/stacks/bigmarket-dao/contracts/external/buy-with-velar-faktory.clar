...
(define-constant WSTX-TOKEN 'SP3HAHEV768GAMP34MTEC83PJ4PG6ZSGBX52CR6XQ.wstx)
(define-constant SHARE-FEE-TO 'SP3HAHEV768GAMP34MTEC83PJ4PG6ZSGBX52CR6XQ.univ2-share-fee-to) 
...
(map-set token-paths LEO-TOKEN 
  {
    pool: 'SP3HAHEV768GAMP34MTEC83PJ4PG6ZSGBX52CR6XQ.wstx-leo,
    pool-id: u28,
  })

(map-set token-paths PEPE-TOKEN 
  {
    pool: 'SP3HAHEV768GAMP34MTEC83PJ4PG6ZSGBX52CR6XQ.wstx-pepe,
    pool-id: u11,
  })

(map-set token-paths ROO-TOKEN 
  {
    pool: 'SP3HAHEV768GAMP34MTEC83PJ4PG6ZSGBX52CR6XQ.wstx-roo,
    pool-id: u15,
  })

(map-set token-paths WELSH-TOKEN 
  {
    pool: 'SP3HAHEV768GAMP34MTEC83PJ4PG6ZSGBX52CR6XQ.wstx-welsh,
    pool-id: u27,
  })
