...
(define-public (execute (sender principal))
	(begin
		...
		(try! (contract-call? .bigmarket-dao set-extensions
			(list
				{
					extension: .bme000-0-governance-token,
					enabled: true,
				}
				{
					extension: .bme001-0-proposal-voting,
					enabled: true,
				}
				{
					extension: .bme003-0-core-proposals,
					enabled: true,
				}
				{
					extension: .bme004-0-core-execute,
					enabled: true,
				}
				{
					extension: .bme006-0-treasury,
					enabled: true,
				}
				{
					extension: .bme010-0-token-sale,
					enabled: true,
				}
				{
					extension: .bme010-0-liquidity-contribution,
					enabled: true,
				}
				{
					extension: .bme021-0-market-voting,
					enabled: true,
				}
				{
				...
				{
					extension: .bme024-0-market-predicting,
					enabled: true,
				}
				{
					extension: .bme024-0-market-scalar-pyth,
					enabled: true,
				}
				{
					extension: .bme030-0-reputation-token,
					enabled: true,
				}
				{
					extension: .bme040-0-shares-marketplace,
					enabled: true,
				}
				{
		...
		(try! (contract-call? .bme003-0-core-proposals set-core-team-member
			'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM true
		))
		(try! (contract-call? .bme003-0-core-proposals set-core-team-member
		...
		(try! (contract-call? .bme024-0-market-predicting set-resolution-agent
			'ST2CY5V39NHDPWSXMW9QDT3HC3GD6Q6XX4CFRK9AG
		))
		(try! (contract-call? .bme024-0-market-predicting set-dev-fund
		...
		(try! (contract-call? .bme024-0-market-predicting set-token-minimum-seed
			'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.wrapped-stx u100
		))
		(try! (contract-call? .bme024-0-market-predicting set-token-minimum-seed
		...
		(try! (contract-call? .bme024-0-market-predicting set-default-hedge-executor
			'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.bme032-0-scalar-strategy-hedge
		))

		(try! (contract-call? .bme024-0-market-scalar-pyth set-resolution-agent
			'ST2CY5V39NHDPWSXMW9QDT3HC3GD6Q6XX4CFRK9AG
		))
		(try! (contract-call? .bme024-0-market-scalar-pyth set-dev-fund
			'ST2JHG361ZXG51QTKY2NQCVBPPRRE2KZB1HR05NNC
		))
		(try! (contract-call? .bme024-0-market-scalar-pyth set-dao-treasury
			.bme006-0-treasury
		))
		...
		(try! (contract-call? .bme024-0-market-scalar-pyth set-default-hedge-executor
			'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.bme032-0-scalar-strategy-hedge
		))
		...
		(try! (contract-call? .bme024-0-market-scalar-pyth set-price-band-width
			0xec7a775f46379b5e943c3526b1c8d54cd49749176b0b98e02dde68d1bd335c17 u2000
		))
		;; BTCUSD
		(try! (contract-call? .bme024-0-market-scalar-pyth set-price-band-width
		...
		;; SOLUSD
		(try! (contract-call? .bme024-0-market-scalar-pyth set-price-band-width
			0xef0d8b6fda2ceba41da15d4095d1da392a0d2f8ed0c6c7bc0f4cfac8c280b56d u1000
		))
		;; ETHUSD
		(try! (contract-call? .bme024-0-market-scalar-pyth set-price-band-width
