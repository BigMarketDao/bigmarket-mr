...
3. Then run [`build-prompts/A-token-wires.md`](./build-prompts/A-token-wires.md) → [`build-prompts/B-homepage.md`](./build-prompts/B-homepage.md) → [`build-prompts/C-market-detail.md`](./build-prompts/C-market-detail.md).
