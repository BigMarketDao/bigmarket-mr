...
2.  docs-v2/build-prompts/A-token-wires.md
3.  docs-v2/build-prompts/B0-header.md
4.  docs-v2/build-prompts/B-homepage.md
5.  docs-v2/build-prompts/C-market-detail.md
6.  docs-v2/build-prompts/audit-B0-header.md          (prior audit of B0)
7.  docs-v2/build-prompts/audit-C-market-detail.md    (prior audit of C)
...
- It does not re-do the deep audits already in [`audit-B0-header.md`](./audit-B0-header.md) and [`audit-C-market-detail.md`](./audit-C-market-detail.md) — it just cross-checks them with fresh eyes.
