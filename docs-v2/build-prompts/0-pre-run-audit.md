...
DO NOT modify the prompt files (docs-v2/build-prompts/A-token-wires.md, B-homepage.md, C-market-detail.md, B0-header.md) or any other file.
...
8. `docs-v2/build-prompts/A-token-wires.md`
9. `docs-v2/build-prompts/B0-header.md`
...
### 3.3 Audit `B0-header.md` (the header-only first build)
...
## 1. Counts
- A-token-wires.md — CSS vars added (light + dark): {N}
- A-token-wires.md — files changed: 3 (`theme.css`, `tokens.ts`, `layout.css`)
- B0-header.md — files changed: {N}
