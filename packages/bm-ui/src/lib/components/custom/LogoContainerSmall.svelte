<script lang="ts">
	...
	const { logo = placeholderImage } = $props<{
		logo: string;
	}>();
...
<div class=""><img src={logo || placeholderImage} alt="Market Logo" onerror={handleError} class="max-h-[150px] min-h-[150px] min-w-[150px] max-w-[150px] place-self-start rounded-sm object-cover" /></div>
