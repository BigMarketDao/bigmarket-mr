<script lang="ts">
  ...
  let sip10Data: Sip10Data = $derived(
    getGovernanceToken(
      ...
      daoConfig.VITE_DAO_GOVERNANCE_TOKEN,
      $allowedTokenStore,
    ),
  );
...
<div class="my-5 rounded-lg bg-gray-50 p-4 shadow-md">
  ...
  <div class="mb-3 flex flex-col">
    ...
    <p>
      Become part of BitcoinDao to participate in market resolution decisions
      much much more
    </p>
  </div>
