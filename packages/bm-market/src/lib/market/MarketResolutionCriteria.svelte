<script lang="ts">
  ...
  function getCriteriaForDisplay(
    m: PredictionMarketCreateEvent,
  ): string | null {
    ...
    if (
      name &&
      plain.localeCompare(name, undefined, { sensitivity: "accent" }) === 0
    ) {
      return null;
    }
  ...
  function isDiscoveryArticleUrl(
    ...
    try {
      ...
      if (
        slugTokens.length >= 2 &&
        slugTokens.filter((t) => descPlain.includes(t)).length >= 2
      ) {
        return true;
      }
    } catch {
  ...
  const resolution = $derived(
    dateOfResolution($chainStore.stacks.burn_block_height, market),
  );
      ...
      <div class="border-t border-[var(--color-border)] p-4">
        <div class="max-w-none text-sm text-[var(--color-muted-foreground)]">
          ...
          <div class="mt-4 border-t border-[var(--color-border)] pt-4">
            <h3
              class="mb-3 text-sm font-semibold text-[var(--color-card-foreground)]"
            >
              Timeline
            </h3>
              ...
              {#if market.marketType === 2}
                ...
                >
                  ...
                  <div class="min-w-0 flex-1">
                    ...
                    <p
                      class="mt-0.5 text-sm text-[var(--color-muted-foreground)]"
                    >
              ...
              >
                ...
                <div class="min-w-0 flex-1">
                  ...
                  >
                    ...
                    {:else}
                      The outcome is checked automatically using verified public
                      sources. No single person decides.
                    {/if}
                  </p>
                </div>
              </div>
              ...
              {#if validationSources.length > 0}
                ...
                >
                  ...
                  <div class="min-w-0 flex-1">
                    ...
                    <p
                      class="mb-1 mt-0.5 text-xs text-[var(--color-muted-foreground)]"
                    >
                    ...
                    <div class="space-y-1">
                      {#each validationSources as source (source)}
                        ...
                        {:else}
                          <span
                            class="block text-sm text-[var(--color-muted-foreground)]"
                          >
                            {source.trim()}
                          </span>
                        {/if}
