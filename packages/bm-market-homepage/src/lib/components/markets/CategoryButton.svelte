...
<button
	...
	onclick={handleClick}
	class={[
		'relative inline-flex shrink-0 cursor-pointer items-center whitespace-nowrap rounded-md px-3 py-2 text-xs font-semibold tracking-wide transition-colors duration-200',
