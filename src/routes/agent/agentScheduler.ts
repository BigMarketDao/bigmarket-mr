...
export const initCreateMarketsJobBitcoin = cron.schedule('25 14 * * 3', async (fireDate) => {
...
export const initCreateMarketsJobStacks = cron.schedule('20 14 * * 3', async (fireDate) => {
	console.log('Running: initCreateMarketsJob at: ' + fireDate);
	try {
