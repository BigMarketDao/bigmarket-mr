...
export const initCreateMarketsJobBitcoin = cron.schedule('05 14 * * 3', async (fireDate) => {
...
export const initCreateMarketsJobStacks = cron.schedule('10 14 * * 3', async (fireDate) => {
	console.log('Running: initCreateMarketsJob at: ' + fireDate);
	try {
...
export const initCreateMarketsJobEthereum = cron.schedule('15 14 * * 3', async (fireDate) => {
	console.log('Running: initCreateMarketsJob at: ' + fireDate);
	try {
